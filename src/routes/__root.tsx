...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", sizes: "180x180", href: "/api/public/brand-icon.png" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/api/public/brand-icon.png" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/api/public/brand-icon.png" },
